<?php
// src/Wyg/UserBundle/Entity/User.php
...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Wyg\MeetupBundle\Entity\Meetup", mappedBy="owner_id")
     */
    protected $meetups;
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Wyg\MeetupBundle\Entity\Meetup", mappedBy="attendees")
...
//        $this->password = $encoder->encodePassword($password, $this->getSalt());
     ...
     * Add meetups
     *
     * @param Wyg\MeetupBundle\Entity\Meetup $meetups
     */
    public function addMeetup(\Wyg\MeetupBundle\Entity\Meetup $meetups)
    {
